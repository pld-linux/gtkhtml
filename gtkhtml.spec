...
License:	LGPL
Group:		X11/Libraries
Source0:	http://ftp.gnome.org/pub/gnome/sources/gtkhtml/3.11/%{name}-%{version}.tar.bz2
# Source0-md5:	e1c38c3c12371281895353e25757b959
...
BuildRequires:	gnome-icon-theme >= 2.15.91
